...
import { BACKEND_URL } from '../utility/config.js';
    ...
    return (
        <div className="min-h-screen bg-gray-900 flex flex-col">
            ...
            <div className="flex-1 overflow-hidden pt-2">
                <div className="h-full w-full flex gap-6 p-2">
                                        ...
                                        (
                                            <div className="flex w-full relative">
                                                <div className="w-full p-2">
                                                    <div className="h-[6rem] mon-w-[15rem] border border-gray-700 bg-transparent text-gray-300 rounded-lg p-3">
                                                        <textarea
                                                            value={userPrompt}
                                                            onChange={(e) => { setPrompt(e.target.value) }}
                                                            name="chat"
                                                            className="flex-grow resize-none scroll-hidden bg-transparent h-full outline-none text-gray-300 placeholder-gray-500"
                    ...
                    {/* Code Editor */}
                    <section className='w-full border-2 border-gray-800 rounded-3xl'>
